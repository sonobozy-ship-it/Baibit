...
SCALP_SYMBOLS = [
    ...
    "XRPUSDT",        # ~$0.50/лот
    "1000PEPEUSDT",   # micro-lot, высокая волатильность, много шортов
    "WIFUSDT",        # ~$1-2/лот, мем-коин, резкие откаты
    "ADAUSDT",        # ~$0.35/лот
    "TRXUSDT",        # ~$0.12/лот
    "XLMUSDT",        # ~$0.11/лот
    "1000SHIBUSDT",   # micro-lot
    "VETUSDT",        # ~$0.03/лот
    "SOLUSDT",        # ~$80-100/лот, высокая ликвидность
]
