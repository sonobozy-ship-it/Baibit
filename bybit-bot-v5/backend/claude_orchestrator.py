...
== ЗАПРЕЩЕНО ==
- НИКОГДА не используй paper_off — переключение в реальный режим только вручную пользователем!
- paper_off удалён из доступных команд намеренно, это защита от случайной торговли реальными деньгами.
- НИКОГДА не используй scalp_off — скальпинг всегда должен работать, отключить может только пользователь вручную.
- scalp_off удалён из доступных команд намеренно.
